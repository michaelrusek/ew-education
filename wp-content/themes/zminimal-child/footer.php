        ...
        <div class="container">
            <form action="#" class="newsletter">
                ...
                <p class="newsletter__tagline">
                    Dołącz do naszego newslettera, aby być na bieżąco z nowościami.
                </p>

                <div class="newsletter__fields">
                    <input class="newsletter__input" type="email" name="email" placeholder="Twój adres email" required>
                    <button class="newsletter__button">Zapisz mnie</button>
                </div>

                <p class="newsletter__rodo">
                    Zgadzam się z polityką prywatności i regulaminem serwisu.
                </p>
            </form>
        </div>
    </div>
